...
const products = [
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 96,
    description: 'Lựa chọn kinh tế cho gia đình. Tiết kiệm hơn 14% so với mua 2 túi 500g.',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1611171711912-e3f65fe9e6b8?w=500&h=500&fit=crop',
    badge: 'Ưu đãi nhất',
    rating: 5.0,
    reviews: 54,
    description: 'Mua 3 tặng 1 — tiết kiệm tối đa. Lý tưởng để dùng lâu dài hoặc làm quà.',
    features: ['4 túi 500g', 'Hộp quà đẹp', 'Thiệp cảm ơn', 'Miễn phí giao hàng'],
  },
  {
    id: 4,
    ...
    image: 'https://images.unsplash.com/photo-1607004468138-e7e23ea26947?w=500&h=500&fit=crop',
    badge: 'Quà tặng',
    rating: 4.9,
    reviews: 41,
    description: 'Hộp quà sang trọng, thích hợp biếu tặng người thân dịp lễ, tết.',
    features: ['Hộp quà cao cấp', 'Ruy băng trang trí', 'Thiệp chúc mừng', 'Miễn phí in tên'],
  },
]
